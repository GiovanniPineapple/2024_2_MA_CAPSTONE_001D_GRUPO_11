...
passport.use(new GitHubStrategy({
  clientID: 'Ov23lie4nQtqWHW795E2',       // Reemplaza con tu Client ID de GitHub
  clientSecret: 'b4c99d266c60d4b4ef3625d0e38ef60014b1ba1f',  // Reemplaza con tu Client Secret de GitHub
  callbackURL: 'https://andesk9/auth/github/callback'  // La URL de redirección (Asegúrate de que coincida con lo que configuraste en GitHub)
},
function(accessToken, refreshToken, profile, done) {
  // Aquí puedes guardar la información del perfil de usuario (por ejemplo, en una base de datos)
...
app.post('/initiate-payment', async (req, res) => {
  ...
  const returnUrl = "https://11csvp4w-3000.brs.devtunnels.ms/payment-result"; // URL para la respuesta de Webpay
